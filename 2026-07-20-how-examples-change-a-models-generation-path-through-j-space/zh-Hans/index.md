---
title: "J-Space 告诉你为什么 Examples 可以形塑模型行为"
...
![示意图：左侧人脑，右侧带高亮中心节点的网络，中间以问号相连，表示人脑全局工作区与模型内部工作区的类比](../global-workspace.png "人脑全局工作区与模型工作区")

人类的 Global Workspace 不一定是词，它可以是画面、感觉、目标、判断。而语言模型最后输出的是 token，所以 Anthropic 发明了一种方法：通过一种叫 J-lens 的工具以 token 作为测量尺，去观察模型内部哪些概念此刻更容易被「说出来」。
