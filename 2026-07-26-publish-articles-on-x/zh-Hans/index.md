...
想必经常写 X Article（长文）的朋友都被 X 长文编辑体验折磨过，而我却鲜少被折磨。究其原因是因为我都是在本地用 Markdown 写完再用了一些「魔法」快速倒腾至 X 上的。并且 Markdown 有一个好处是可以作为个人 AI 工作流的数据中枢和个人上下文库，上承各种输入设备可以语音转文字、龙虾和 Hermes，下游则可以产出各种自媒体平台资产——比如 AI 自动口播剪辑、文章自动生成。

正好今天看见又有 X 友被 X 长文写作体验折磨，我就和大家一起分享一下。
